...
(1, 'Nagaraj P', 'Shristi', '123456', 'shristi@gmail.com', 'What is your fav spot?', 'Bangalore', 'ISE');
...
(1, 'IT', 'IT', '123456', 'rh@gmail.com', 'What is your fav spot?', 'mangalore');
...
(1, 'Karan', 'karan', '123456', 'karan@gmail.com', 'What is your fav spot?', 'madikeri');
...
(1, 'veda', 'Tanisha123', '123', 'veda', 'What is your fav spot?', 'circket'),
...
ALTER TABLE `updatedrive`
 ADD KEY `USN` (`USN`), ADD KEY `CompanyName` (`CompanyName`,`Date`);
