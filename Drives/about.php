...
<link rel="style.sheet" href="css/bootstrap.css" type="text/css" media="all" />
				...
				<div class="top-nav">
					...
					<ul class="nav1">
						<li class="hvr-sweep-to-bottom">
								<a href="../Homepage/index.php">PW-PMS<i>Goto Placement Homepage</i></a>
							</li>
						<li class="hvr-sweep-to-bottom">
	...
	<!-- footer -->
		<div class="footer">
			...
			<div class="container">
				...
				<div class="col-md-3 footer-right  wow fadeInRight animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<h6 style="color: white">Projectsworlds Institute of Technology</h6>
					<h4>
		...
		<div class="copyright">
			...
			<div class="container">
              ...
              <a href="http://Projectsworlds.in" target="_parent">Gajendra Pradhan</a>
					</p>
				</div>
