	        	...
	        	<div class="form-group">
	        		<div class="input-group">
		        		<div class="input-group-addon"><i class="fa fa-user fa-fw"></i></div>	        		
		              	<input type="text" autocomplete="off" class="form-control" placeholder="USN" name="username">           
		          	</div>	
	        	</div>
	        	<div class="form-group">
	        		<div class="input-group">
			...
			<div class="container">
				<div class="col-md-3 ftr_navi ftr">
					...
					<ul>
						...
						<li>
							<a href="../SProfile/home.php">Student Login</a>
						</li>
						<li>
				...
				<div class="col-md-3 get_in_touch ftr">
					<h3>GET IN TOUCH</h3>
					<p>Ayurvihar Somaiya Complex</p>
					<p>Everard Nagar Sion(East)(India)</p>
              ...
              <a href="http://www.kijsieit.com" target="_parent">KJSIEIT GROUP</a>
				</div>
				</div>
