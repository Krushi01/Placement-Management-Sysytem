      ...
      <div class="templatemo-sidebar">
        ...
        <nav class="templatemo-left-nav">
          <ul>
           ...
           <!--  <li>
              <a href="drivehome.php"><i class="fa fa-bar-chart fa-fw"></i>Placement Drives</a>
            </li> -->
            <li>
        ...
        <div class="templatemo-content-container">
          <div class="templatemo-flex-row flex-content-row">
            <div class="templatemo-content-widget white-bg col-2">
              ...
              <div class="square"></div>
              <h2 class="templatemo-inline-block">Welcome to KJSIEIT</h2>
              <hr>
              ...
              <!-- <div class="templatemo-content-widget white-bg">
                ...
                <div class="media">
                  ...
                  <div class="media-body">
                    ...
                    <p>Brace yourself for the Events that will take ur breath away. Get Started and be a Part of KJSIEIT GROUP Family</p>
                  </div>
                </div>
              </div> -->
            </div>
