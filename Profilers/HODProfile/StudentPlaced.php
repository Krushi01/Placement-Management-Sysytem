      ...
      ?>
        ...
        <nav class="templatemo-left-nav">          
         ...
         <ul>
            ...
            <li><a href="manage-users1.php" class="active"><i class="fa fa-users fa-fw"></i>Manage Students</a></li>
            <!-- s<li><a href="preferences.php"><i class="fa fa-sliders fa-fw"></i>Preferences</a></li> -->
      ...
      <div class="templatemo-content col-1 light-gray-bg">
        ...
        <table class="table table-striped table-bordered templatemo-user-table">
          ...
          <td><a   class="white-text templatemo-sort-by">USN</a></td>
                    ...
                    <td><a  class="white-text templatemo-sort-by">Written Test </a></td>
                    <td><a class="white-text templatemo-sort-by">Group Discussion  </a></td>
...
$sql = "SELECT * FROM updatedrive ORDER BY Date DESC LIMIT $start_from, $num_rec_per_page"; 
...
print "<td>" . $row['Attendence'] . "</td>"; 
print "<td>" . $row['WT'] . "</td>"; 
print "<td>" . $row['GD'] . "</td>"; 
print "<td>" . $row['Techical'] . "</td>"; 
    ...
    if( $currentpage > 1 && $currentpage <= $totalpage)
      {
        ...
        $prev = $currentpage-1;
        echo "<li><a  href='updatedrive1.php?page=".$prev."'><</a></li>";
...
$prev = $currentpage-1;
  for ($i=$prev+1; $i<=$currentpage+2; $i++){
    echo "<li><a href='updatedrive1.php?page=".$i."'>".$i."</a></li>";
  }
  }
  ...
  {
    $nxt = $currentpage+1;
    echo "<li><a  href='updatedrive1.php?page=".$nxt."' >></a></li>";
  }
