...
{ 
$Csslc = $_POST['csslc'];
$RESULT = mysqli_query("SELECT count(*) FROM basicdetails WHERE `Approve`='1' AND SSLC>='$Csslc'");
$data = mysqli_fetch_assoc($RESULT);
echo "<br><h3>Students Scored Above '$Csslc' in SSLC&nbsp:&nbsp";
echo $data['count(*)'];
echo "</h3>";
$sql = mysqli_query("SELECT * FROM basicdetails WHERE `Approve`='1' AND SSC>='$Csslc'");
