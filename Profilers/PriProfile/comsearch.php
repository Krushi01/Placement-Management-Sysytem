...
<html lang="en">
            ...
            <form action="COUNT2.php" class="templatemo-login-form" method="POST" enctype="multipart/form-data">
                ...
                <br>
        <div class="col-lg-6 col-md-6 form-group" >        
        <label for="sslc">Year</label>
                  <input type="year" name="year" class="form-control" id="sslc" placeholder="">  
        </div>							                                				
           <br>
          ...
          <footer class="text-right">
            <p>Copyright &copy; 2015 KJSIEIT-PMS | Designed by
               Developed by <a href="http:// infotech2somaiya.edu" target="_parent">KJSIEIT Technologies</a>
            </p>
          </footer>      
        </div>
      </div>
