...
{ 
$Cpu = $_POST['cpu'];
$RESULT = mysqli_query("SELECT count(*) FROM basicdetails WHERE `Approve`='1' AND `PU/Dip`>='$Cpu'");
$data = mysqli_fetch_assoc($RESULT);
echo "<br><h3>Students Scored Above '$Cpu' in PU/Diploma&nbsp:&nbsp";
echo $data['count(*)'];
echo "</h3>";
$sql = mysqli_query("SELECT * FROM basicdetails WHERE `Approve`='1' AND `PU/Dip`>='$Cpu'");
...
?>
 ...
 <footer class="text-right">
            ...
            |  Developed by <a href="http:// infotech@somaiya.edu" target="_parent">KJSIEIT Technologies</a></p>
          </footer>         
        </div>
      </div>
    </div>    
