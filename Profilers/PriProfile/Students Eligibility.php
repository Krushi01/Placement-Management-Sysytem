         ...
         <div class="templatemo-content-container">
          <div class="templatemo-content-widget white-bg">
            ...
            <form action="eligibility.php" class="templatemo-login-form" method="POST" enctype="multipart/form-data">
              ...
              <div class="row form-group">
				...
				<div class="col-lg-6 col-md-6 form-group">
                  <label for="sslc">10th Board</label>
                  <input type="text" name="sslc" class="form-control" id="sslc" placeholder="">
                </div>
				<div class="col-lg-6 col-md-6 form-group">
                  <label for="HSC">HSC/Diploma </label>
                  <input type="text" name="HSC" class="form-control" id="HSC" placeholder="">
                </div>
				<div class="col-lg-6 col-md-6 form-group">
                  <label for="cgpi">Overall cgpi</label>
                  <input type="text" name="cgpi" class="form-control" id="cgpi" placeholder="">
                </div>
                <div class="col-lg-6 col-md-6 form-group">
          ...
          <footer class="text-right">
             <p>Copyright &copy; 2018 KJSIEIT-PMS | Developed by
              <a href="http:// kjsieit.com" target="_parent">KJSIEIT Technologies</a></p>
          </footer>      
        </div>
      </div>
    </div>
