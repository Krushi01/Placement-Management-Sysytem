...
{ 
$Csslc = $_POST['csslc'];
$RESULT = mysqli_query("SELECT count(*) FROM basicdetails WHERE `Approve`='1' AND SSCC>='$Cssc'");
$data = mysqli_fetch_assoc($RESULT);
echo "<br><h3>Students Scored Above '$Cssc' in SSC&nbsp:&nbsp";
echo $data['count(*)'];
echo "</h3>";
$sql = mysqli_query("SELECT * FROM basicdetails WHERE `Approve`='1' AND SSC>='$Cssc'");
