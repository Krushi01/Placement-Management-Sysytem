...
{ 
$Cpu = $_POST['cpu'];
$RESULT = mysqli_query("SELECT count(*) FROM basicdetails WHERE `Approve`='1' AND `HSC/Dip`>='$HSC/Dip'");
$data = mysqli_fetch_assoc($RESULT);
echo "<br><h3>Students Scored Above '$Cpu' in HSC/Diploma&nbsp:&nbsp";
echo $data['count(*)'];
echo "</h3>";
$sql = mysqli_query("SELECT * FROM basicdetails WHERE `Approve`='1' AND `HSC/Dip`>='$Cpu'");
