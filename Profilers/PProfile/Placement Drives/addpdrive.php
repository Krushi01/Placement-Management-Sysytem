            ...
            <form action="add pdrive1.php" class="templatemo-login-form" method="POST" enctype="multipart/form-data">
			  ...
			  <div class="row form-group">
                <div class="col-lg-6 col-md-6 form-group">
                  ...
                  <input type="text" name="CompanyName" class="form-control" id="inputCompanyName" placeholder="company">
                </div>
				</div>

        <div class="row form-group">
                <div class="col-lg-6 col-md-6 form-group">
                  <label class="control-label templatemo-block">Campus Type</label>
