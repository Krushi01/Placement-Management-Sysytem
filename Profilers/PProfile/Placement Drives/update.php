            ...
            <form action="updatedrive1.php" class="templatemo-login-form" method="post" enctype="multipart/form-data">
              <div class="row form-group">
				...
				<div class="col-lg-6 col-md-6 form-group">
                  ...
                  <input type="text" autocomplete="off" name="usn" class="form-control" id="inputusn" placeholder="">
                </div>
                
				<div class="col-lg-6 col-md-6 form-group">
                  <label for="Name">Student Name</label>
                  <input type="text" autocomplete="off" name="sname" class="form-control" id="inputName" placeholder="">
                </div>
				
				<div class="col-lg-6 col-md-6 form-group">
                  <label for="Name">Company Name</label>
                  <input type="text" autocomplete="off"  name="comname" class="form-control" id="inputName" placeholder="">
                </div>
