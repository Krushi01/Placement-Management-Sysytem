      ...
      <div class="templatemo-content col-1 light-gray-bg">
          ...
          <div class="row">
            <nav class="templatemo-top-nav col-lg-12 col-md-12">
              <ul class="text-uppercase">
                  <li><a href="../../Homepage/indes.php">Home KJSIEIT-PMS</a></li>
        ...
        <div class="templatemo-content-container">
                ...
                <div class="media">
                  <div class="media-left">
                    <a href="Placement Drives/addpdrive.php">
                      <img class="media-object img-circle" src="images/clg_img.png" alt="" width="20px" height="20px">
                    </a>
                  </div>
                ...
                <div class="media">
                  <div class="media-left">
                   <a href="Placement Drives/update.php">
                      <img class="media-object img-circle" src="images/UD.png" alt="" width="20px" height="20px">
                   </a>
                  </div>
                  <div class="media-body">
                ...
                <div class="media">
                  <div class="media-left">
                    <a href="Placement Drives/Companydetails.php">
                      <img class="media-object img-circle" src="images/clg_img.jpg" alt="" width="20px" height="20px">
                    </a>
                  </div>
                  <div class="media-body">
          ...
          <footer class="text-right">
            ...
            | Designed by <a href="http://www.kjsieit.com" target="_parent">KJSIEIT Technologies</a></p>
          </footer>       
        </div>
      </div>
    </div>
