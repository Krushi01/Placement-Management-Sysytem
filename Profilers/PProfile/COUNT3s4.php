...
$RESULT = mysqli_query("SELECT count(*) FROM basicdetails WHERE `Approve`='1' AND Branch='$Cbranch'");
$data = mysqli_fetch_assoc($RESULT);
echo "<br><h3>Students in '$Cbranch' Branch&nbsp:&nbsp";
echo $data['count(*)'];
echo "</h3>"; 
$sql = mysqli_query("SELECT * FROM basicdetails WHERE `Approve`='1' AND Branch='$Cbranch' ORDER BY FirstName");
