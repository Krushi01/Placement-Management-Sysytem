            ...
            <form action="add pdrive1.php" class="templatemo-login-form" method="POST" enctype="multipart/form-data">
              <div class="row form-group">
                <div class="col-lg-6 col-md-6 form-group">
                  ...
                  <input type="text" autocomplete="off" name="compny" class="form-control" id="inputFirstName" placeholder="company">
                </div>
                <div class="col-lg-6 col-md-6 form-group">
				...
				<div class="col-lg-6 col-md-6 form-group">
                  ...
                  <input type="text" autocomplete="off" name="sslc" class="form-control" id="sslc" placeholder="">
                </div>
				<div class="col-lg-6 col-md-6 form-group">
				...
				<div class="col-lg-6 col-md-6 form-group">
                  ...
                  <input type="text" autocomplete="off" name="beagg" class="form-control" id="BE" placeholder="">
                </div>
                <div class="col-lg-6 col-md-6 form-group">
