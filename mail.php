...
<title>KJSIEIT-PMS | Contact Us</title>
				...
				<div class="top-nav">
					...
					<ul class="nav1">
						<li class="hvr-sweep-to-bottom">
							<a href="http://localhost/Placement-Management-System-master/homepage/index.php">KJSIEIT-PMS<i>Goto Placement Homepage</i></a>
							</li>
						<li class="hvr-sweep-to-bottom">
	...
	<div class="mail">
		...
		<div class="container">
			<div class="map footer-middle wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
				<!-- <iframe src="https://www.google.com/maps/embed/v1/place?q=Sri%20KJSIEIT%20Institute%20of%20Technology%2C%20KJSIEIT%2C%20Maharashtra%2C%20India&key=AIzaSyATLPQdEcx47VybeMCQzR36pLuNuItNKP8""  -
			</div>
			<div class="mail-grids">
				<div class="col-md-6 mail-grid-left wow fadeInLeft animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<h3>Contact Us</h3>	
					<p></p>				
					<h4>K.J.Somaiya Institute of Engineering And Information Technology</h4>
					<p>Somaiya Ayurvihar Complex,
						<span>Everard Nagar,Sion(East)</span>
						
					</p>
					<h4>Get In Touch</h4>
					<p>Telephone: 91-22-24061403/24061403
						<span>FAX: +91 9978564521 </span>
						E-mail: <a href="mailto:infotech@somaiya.edu">infotech@somaiya.edu</a>
					</p>
				</div>
	...
	<!-- footer -->
		<div class="footer">
			...
			<div class="container">
				...
				<div class="col-md-3 footer-right  wow fadeInRight animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<h6 style="color: white">K.J.Somaiya Institute of Engineering And Information Technology</h6>
					<h4>
		...
		<div class="copyright">
			...
			<div class="container">
              ...
              <a href="http://PROJECTWORLDS.IN" target="_parent">KJSIEIT Technologies</a>
				</div>
