        ...
        <nav id="mainNav" class="navbar navbar-default navbar-fixed-top" style="background:black">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand page-scroll" href="http://localhost/Placement-Management-System-master/index.php">KJSIEIT'S PLACEMENT PORTAL</a>
                </div>
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li>
                            <a class="page-scroll" href="../Profilers/PriProfile/index.php">Principal Login</a>
                        </li>
                    </ul>
        ...
        <header>
            <div class="header-content">
                <div class="header-content-inner">
                    <h1>KJSIEIT PLACEMENT PORTAL</h1>
                    ...
                    <!-- <p>We are here to Build your Skills and Career with our Driven Passion and Reality.</br>Click Below to Get Our Current Drive
                        Details</p>
                    <a href="../Drives/products.php" class="btn btn-primary btn-xl page-scroll">Current Drives</a>
   -->              </div>
            </div>
        </header>
        <div class="footer">
			<div class="container">
				<div class="col-md-3 ftr_navi ftr">
					...
					<ul>
						<li>
							<a href="http://localhost/Placement-Management-System-master/index.php">Home</a>
						</li>
						<li>
				...
				<div class="col-md-3 ftr-logo">
					<p>K.J.Somaiya Institue of Engineering Anf Information Technology &copy; TS2538 @2020 K.J.Somaiya Institue of Engineering And Information Technology| Developed by
              <a href="index.php" target="_parent">KJSIEIT GROUP </a>
				</div>
