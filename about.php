...
<body>
	...
	<div class="about-bottom">
		<!-- container -->
		<div class="container">
			<h3 class="wow fadeInRight animated" style="visibility: visible;">A New Generation of KJSIEIT</h3>
		...
		<div class="footer">
			...
			<div class="container">
				...
				<div class="col-md-3 footer-middle wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<h3>Address</h3>
					<div class="address">
						<p>Somaiya Ayurvihar Complex, Everard Nagar,Sion(East)
							<span>KJSIEIT GROUP</span>
						</p>
					</div>
					<div class="phone">
				...
				<div class="col-md-3 footer-right  wow fadeInRight animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					...
					<h4>
						<a href="../Homepage/index.php" style="color: white">KJSIEIT Placement Portal</a>
					</h4>
					<p></p>
				</div>
				<div class="clearfix"></div>
